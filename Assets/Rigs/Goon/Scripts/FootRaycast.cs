...
public class FootRaycast : MonoBehaviour {
    ...
    /// <summary>
    ///  The world space position of the ground
    ///  above/below the foot IK.
    /// </summary>
    private Vector3 groundPosition;

    /// <summary>
    /// The world space rotation for the foot to be allignment on the ground
    /// </summary>
    private Quaternion groundRotation;

    /// <summary>
    /// The local-space for us to ease towards. This allows us to animate the position
    /// </summary>
